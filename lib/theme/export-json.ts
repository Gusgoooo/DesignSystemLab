...
export const themeLabAiCodingRules = [
  ...
  "For long-term projects, fully land the persistent token contract and local design-rule router in the target project; raw GitHub links are only a bootstrap/reference source, not the finished local contract.",
